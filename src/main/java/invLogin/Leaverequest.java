...
public class Leaverequest extends HttpServlet{
	protected void doGet(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException
    {
        ...
        try 
        {
            ...
            ResultSet rs=st.executeQuery("select * from Log where Status='Pending';"); 
            req.setAttribute("leaverequests",rs);
            RequestDispatcher view = req.getRequestDispatcher("/Leaverequest.jsp");  
